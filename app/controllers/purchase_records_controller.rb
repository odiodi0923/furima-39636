class PurchaseRecordsController < ApplicationController
  ...
  def record_params
    params.require(:purchase_info).permit(:postal_code, :region_id, :city, :street_num, :building, :phone, :purchase_record).merge(user_id: current_user.id, item_id: params[:item_id], token: params[:token])
  end
